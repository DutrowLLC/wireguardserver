...
if [[ "$EUID" -ne 0 ]]; then
        ...
        echo "Maybe try this:"
        echo "curl https://raw.githubusercontent.com/DutrowLLC/wireguardserver/master/wireguardinstall.sh | sudo bash"
        exit
fi
...
ExecStart=/root/.nvm/versions/node/v10.24.1/bin/node /opt/wg-dashboard/src/server.js
